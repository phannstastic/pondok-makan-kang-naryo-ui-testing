...
WebUI.click(findTestObject('Page_Restaurant Order/div_Bakso                Rp12.000                                                                                                    0'))

WebUI.click(findTestObject('Page_Restaurant Order/button_Bakso_add-item-btn w-8 h-8 flex item_3bcc42'))

WebUI.click(findTestObject('Page_Restaurant Order/button_Bakso_remove-item-btn w-8 h-8 flex i_aa231a'))
