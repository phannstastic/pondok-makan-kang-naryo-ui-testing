...
WebUI.click(findTestObject('Object Repository/Page_Login - Laravel/input__data.password'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Dashboard - Laravel/h1_Dashboard'))
