...
WebUI.click(findTestObject('Object Repository/Page_Dashboard - Laravel/button_Sign out'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Login - Laravel/main_Laravel                               _f6ea21'))
