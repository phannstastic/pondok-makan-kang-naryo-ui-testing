...
WebUI.setText(findTestObject('Object Repository/Page_Create Menu Item - Laravel/input_Rp_data.price'), '12000')

WebUI.click(findTestObject('Object Repository/Page_Create Menu Item - Laravel/button_Create'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Create Menu Item - Laravel/p_The gambar Menu field is required'))
