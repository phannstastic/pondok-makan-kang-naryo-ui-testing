...
WebUI.click(findTestObject('Object Repository/Page_Dashboard - Laravel/span_Galleries'))

WebUI.click(findTestObject('Object Repository/Page_Galleries - Laravel/span_New gallery'))

WebUI.click(findTestObject('Object Repository/Page_Create Gallery - Laravel/button_Create'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Create Gallery - Laravel/p_The gambar field is required'))
